...
namespace Call_pyhon_translate
{
    public partial class Form1 : Form
    {
        ...
        void Init_Lang_to_Choice()
        {
            ...
            List<ComboxItem> L1 = JsonConvert.DeserializeObject<List<ComboxItem>>(json);
            List<ComboxItem> L2 = JsonConvert.DeserializeObject<List<ComboxItem>>(json);
            cbox_lang1.DisplayMember = "Text";
            cbox_lang1.ValueMember = "Value";
            cbox_lang1.DataSource = L1;
            cbox_lang1.SelectedValue = "vi"; //mặc định ban đầu chơi tiếng việt

            cbox_Lang2.DisplayMember = "Text";
            cbox_Lang2.ValueMember = "Value";
            cbox_Lang2.DataSource = L2;
            cbox_Lang2.SelectedValue = "en";  //mặc định ban đầu chơi tiếng anh
        ...
        private void btn_translate_Click(object sender, EventArgs e)
        {
            try
            {
                txtKQ.Text = $"dich.py {cbox_lang1.SelectedValue} {cbox_Lang2.SelectedValue} \"{txtSource.Text}\"";
                ProcessStartInfo startInfo = new ProcessStartInfo()
                {
                    WindowStyle = ProcessWindowStyle.Hidden,
                    WorkingDirectory = "D:\\C#_programming\\Githubfolder\\C_Sharp\\Call_pyhon_translate",
                    FileName = @"C:\Users\Veng Ann\AppData\Local\Programs\Python\Python311\python.exe",  //có thể trên máy bạn sẽ khác path này
                    Arguments = $"dich.py {cbox_lang1.SelectedValue} {cbox_Lang2.SelectedValue}  \"{txtSource.Text}\"", //truyền đc lang và text cần nói sang python
                ...
                p.WaitForExit();
                //đọc từ file: vì console ko truyền tải đc kí tự khó
                txtKQ.Text = System.IO.File.ReadAllText("D:\\C#_programming\\Githubfolder\\C_Sharp\\Call_pyhon_translate" + "\\kq.txt");
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ProcessStartInfo startInfo = new ProcessStartInfo()
                {
                    ...
                    WorkingDirectory = "D:\\C#_programming\\Githubfolder\\C_Sharp\\Call_pyhon_translate",
                    FileName = @"C:\Users\Veng Ann\AppData\Local\Programs\Python\Python311\python.exe",  //có thể trên máy bạn sẽ khác path này
                    Arguments = $"gen_voice.py {cbox_Lang2.SelectedValue} \"{txtKQ.Text}\"", //truyền đc lang và text cần nói sang python
                    RedirectStandardOutput = true,
                    CreateNoWindow = true,
                    UseShellExecute = false
                };
                ...
                while (!p.StandardOutput.EndOfStream)
                {
                    ...
                    if (line.EndsWith(".mp3"))
                        lbel_status.Text = "Playing file: " + line;
                    else
                        lbel_status.Text = line; //đây là các báo lỗi trong python
                    get_text = true;
                    break; //vì code python chỉ ra 1 dòng, nên gặp 1 dòng là té luôn
                }
                if (!get_text) //có khi nào mà python lại ko print ra chữ nào??
                    lbel_status.Text = "Chưa tạo được file mp3";
            }
            catch (Exception ex)
            {
                lbel_status.Text = "Error: " + ex.Message;
            }
        ...
        {
            int a = cbox_lang1.SelectedIndex;
            int b = cbox_Lang2.SelectedIndex;
            cbox_lang1.SelectedIndex = b;
            cbox_Lang2.SelectedIndex = a;
        }
    }
}
